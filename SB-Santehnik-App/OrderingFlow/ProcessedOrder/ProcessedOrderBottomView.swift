//
//  ProcessedOrderBottomView.swift
//  Rocket10
//
...
// MARK: -
final class ProcessedOrderBottomView: UIView {
  
  let titleLabel: UILabel = {
    $0.translatesAutoresizingMaskIntoConstraints = false
    $0.text = "Скоро с вами свяжется\nоператор для согласования"
  ...
  let continueButton: BigButton = {
    $0.translatesAutoresizingMaskIntoConstraints = false
    $0.configure(withTitle: "Перейти к заказу")
    return $0
...
extension ProcessedOrderBottomView {
